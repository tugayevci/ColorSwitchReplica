...
public class LevelGeneratorRotate : MonoBehaviour
{
    ...
    public void SingleCircleGenerator(Rigidbody2D rb)
    {
        ...
        singleCircle.transform.localScale = new Vector3(randomScale, randomScale, RandomScaleGenerator()); // change its local scale in x y z format

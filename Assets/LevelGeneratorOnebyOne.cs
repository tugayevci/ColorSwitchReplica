...
public class LevelGeneratorOnebyOne : MonoBehaviour
{
    ...
    public void ColorChangerSpawner(Rigidbody2D rb)
    {
        ...
        spawnPosition.x = 0f;
        spawnPosition.y = PlayerOneByOneMode.nextObstacleCoor.y;
    ...
    public void SingleLineGenerator(Rigidbody2D rb)
    {
        // New line creator
        Vector3 spawnPosition = new Vector3();
        spawnPosition.y = PlayerOneByOneMode.nextObstacleCoor.y-(2.5F);
        spawnPosition.x = 0f;
